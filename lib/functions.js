...
const storeCSSToIPFS = async (name, name_css, file_ipfs) => {
...
const storeMetadataToIPFS = async (name, name_css, css_ipfs) => {
  // for metadata
  const metadata = new Blob(
    [
      `{
      "description": "${name} font for OurFonts", 
      "external_url": "https://${css_ipfs}.ipfs.nftstorage.link/${name_css}", 
